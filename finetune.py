...
<<<<<<< HEAD
model = YOLO('yolov8s-p2-ghost_dynamic.yaml', task='detect') #.load('./../models/yolov8s.pt')
...
batch = 16
optimizer = 'SophiaG'
>>>>>>> e78a726375420b3dace17b02eef236f83948333d
...
model.train(
    ...
    name=f'8sp2-ghost_dynamic-{epochs}e-{batch}b-CW_C2N',
    verbose=True,
    cache=False,
    amp=False
)