...
class Track:
    ...
    def __init__(self, bbox, frame_id, track_id, class_id, score):
    ...
    def update(self, box, frame_id, class_id, score):
...
class SFSORT:
    ...
    def __init__(self, args, video_info):
        ...
        self.dynamic_tuning = args.dynamic_tuning
        ...
        frame_width, frame_height = video_info.resolution_wh

        self.marginal_timeout = (5 * frame_rate // 10)
        self.central_timeout = frame_rate
        self.l_margin = frame_width // 10
        self.t_margin = frame_height // 10
        self.r_margin = frame_width - self.l_margin
        self.b_margin = frame_height - self.t_margin
    ...
    def update(self, detections, frame=None):
        ...
        if high_score.any():
            ...
            definite_class_ids = class_ids[high_score]
            if track_pool:           
                ...
                for track_idx, detection_idx in matches:
                    ...
                    class_id = definite_class_ids[detection_idx]
        ...
        tracker_ids = np.array(track_ids, dtype=int) if track_ids else np.empty(0, dtype=int)
        ...
        return detections, next_active_tracks
