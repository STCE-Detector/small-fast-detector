...
if __name__ == "__main__":
    ...
    export_configs = [
        ...
        {'format': 'engine',
         'args': {'imgsz': 640, 'half': False, 'dynamic': False, 'int8': False, 'simplify': False, 'workspace': 6}},
        {'format': 'engine',
         'args': {'imgsz': 1280, 'half': False, 'dynamic': False, 'int8': False, 'simplify': False, 'workspace': 6}},
        {'format': 'engine',
         'args': {'imgsz': 640, 'half': False, 'dynamic': False, 'int8': False, 'simplify': True, 'workspace': 6}},
        {'format': 'engine',
         'args': {'imgsz': 1280, 'half': False, 'dynamic': False, 'int8': False, 'simplify': True, 'workspace': 6}},
        {'format': 'engine',
         'args': {'imgsz': 640, 'half': True, 'dynamic': False, 'int8': False, 'simplify': True, 'workspace': 6}},
        {'format': 'engine',
         'args': {'imgsz': 1280, 'half': True, 'dynamic': False, 'int8': False, 'simplify': True, 'workspace': 6}},
        {'format': 'engine',
         'args': {'imgsz': 640, 'half': False, 'dynamic': True, 'int8': True, 'simplify': True, 'workspace': 6}},
        {'format': 'engine',
         'args': {'imgsz': 1280, 'half': False, 'dynamic': True, 'int8': True, 'simplify': True, 'workspace': 6}},
    ]
